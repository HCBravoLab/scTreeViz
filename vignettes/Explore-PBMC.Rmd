...
## Loading data
In this walkthrough we use the pbmc 3k dataset that can be downloaded from [here](https://cf.10xgenomics.com/samples/cell/pbmc3k/pbmc3k_filtered_gene_bc_matrices.tar.gz)
